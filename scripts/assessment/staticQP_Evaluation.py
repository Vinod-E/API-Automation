...
class staticQP_Evaluation(unittest.TestCase):
    def test_staticQP_Evaluation(self):
        ...
        #
        #     mycursor.execute(
        #         'delete from test_results where testuser_id in (select id from test_users where test_id = 5282 and login_time is not null);')
        #     conn.commit()
        #     print('Test result deleted')
        #     mycursor.execute(
        #         'delete from candidate_scores where testuser_id in (select id from test_users where test_id = 5282 and login_time is not null);')
        #     conn.commit()
        #     print('Candidate score deleted')
        #     mycursor.execute(
        #         'delete from test_user_login_infos where testuser_id in (select id from test_users where test_id = 5282 and login_time is not null);')
        #     conn.commit()
        #     print('Test user login info deleted')
        #     mycursor.execute(
        #         'update test_users set login_time = NULL, log_out_time = NULL, status = 0, client_system_info = NULL, time_spent = NULL, is_password_disabled = 0,config = NULL, client_system_info = NULL, total_score = NULL, percentage = NULL where test_id = 5282 and login_time is not null;')
        #     conn.commit()
        ...
        ws.write(0, 80, "Expected Percentage", self.__style0), ws.write(0, 81, "Actual Percentage", self.__style0)
        ...
        while n < sh1.nrows:
            ...
            # print(QuestionId_1_Ans, QuestionId_2_Ans, QuestionId_17_Ans, QuestionId_18_Ans, QuestionId_19_Ans, QuestionId_20_Ans, QuestionId_37_Ans, QuestionId_38_Ans, QuestionId_39_Ans)
            ...
            login_to_test_request = requests.post("https://amsin.hirepro.in/py/assessment/htmltest/api/v2/login_to_test/",
            ...
            submitTestResult_header = {"content-type": "application/json", "X-AUTH-TOKEN": self.login_to_test_TokenVal}
            submitTestResult_data = {"isPartialSubmission": False, "totalTimeSpent": 39,
                                    "testResultCollection": [{"q": QuestionId_1, "timeSpent": 1, "secId": SectionId_1, "a": answer_list[0]},
                                                             ...
                                                             {"q": QuestionId_10, "timeSpent": 1, "secId": SectionId_3, "a": answer_list[9]},
                                                             {"q": QuestionId_11, "timeSpent": 1, "secId": SectionId_3, "a": answer_list[10]},
                                                             {"q": QuestionId_12, "timeSpent": 1, "secId": SectionId_3, "a": answer_list[11]},
                                                             {"q": QuestionId_13, "timeSpent": 1, "secId": SectionId_3, "a": answer_list[12]},
                                                             {"q": QuestionId_14, "timeSpent": 1, "secId": SectionId_3, "a": answer_list[13]},
                                                             {"q": QuestionId_15, "timeSpent": 1, "secId": SectionId_3, "a": answer_list[14]},
                                                             {"q": QuestionId_16, "timeSpent": 1, "secId": SectionId_3, "a": answer_list[15]},
                                                             {"q": QuestionId_17, "timeSpent": 1, "secId": SectionId_4, "a": answer_list[16]},
                                                             {"q": QuestionId_18, "timeSpent": 1, "secId": SectionId_4, "a": answer_list[17]},
                                                             {"q": QuestionId_19, "timeSpent": 1, "secId": SectionId_4, "a": answer_list[18]},
                                                             {"q": QuestionId_20, "timeSpent": 1, "secId": SectionId_4, "a": answer_list[19]},
                                                             {"q": QuestionId_21, "timeSpent": 1, "secId": SectionId_5, "a": answer_list[20]},
                                                             {"q": QuestionId_22, "timeSpent": 1, "secId": SectionId_5, "a": answer_list[21]},
                                                             {"q": QuestionId_23, "timeSpent": 1, "secId": SectionId_5, "a": answer_list[22]},
                                                             {"q": QuestionId_24, "timeSpent": 1, "secId": SectionId_5, "a": answer_list[23]},
                                                             {"q": QuestionId_25, "timeSpent": 1, "secId": SectionId_6, "a": answer_list[24]},
                                                             {"q": QuestionId_26, "timeSpent": 1, "secId": SectionId_6, "a": answer_list[25]},
                                                             {"q": QuestionId_27, "timeSpent": 1, "secId": SectionId_6, "a": answer_list[26]},
                                                             {"q": QuestionId_28, "timeSpent": 1, "secId": SectionId_6, "a": answer_list[27]},
                                                             {"q": QuestionId_29, "timeSpent": 1, "secId": SectionId_6, "a": answer_list[28]},
                                                             {"q": QuestionId_30, "timeSpent": 1, "secId": SectionId_6, "a": answer_list[29]},
                                                             {"q": QuestionId_31, "timeSpent": 1, "secId": SectionId_7, "a": answer_list[30]},
                                                             {"q": QuestionId_32, "timeSpent": 1, "secId": SectionId_7, "a": answer_list[31]},
                                                             {"q": QuestionId_33, "timeSpent": 1, "secId": SectionId_7, "a": answer_list[32]},
                                                             {"q": QuestionId_34, "timeSpent": 1, "secId": SectionId_8, "a": answer_list[33]},
                                                             {"q": QuestionId_35, "timeSpent": 1, "secId": SectionId_8, "a": answer_list[34]},
                                                             {"q": QuestionId_36, "timeSpent": 1, "secId": SectionId_8, "a": answer_list[35]},
                                                             {"q": QuestionId_37, "timeSpent": 1, "secId": SectionId_9, "a": answer_list[36]},
                                                             {"q": QuestionId_38, "timeSpent": 1, "secId": SectionId_9, "a": answer_list[37]},
                                                             {"q": QuestionId_39, "timeSpent": 1, "secId": SectionId_9, "a": answer_list[38]}
                                                            ],
                                    "config": "{\"TimeStamp\":\"2018-03-27T07:28:55.933Z\"}"}

            submitTestResult_request = requests.post("https://amsin.hirepro.in/py/assessment/htmltest/api/v1/submitTestResult/",
            ...
            login_user_header = {"content-type": "application/json"}
            login_user_data = {"LoginName": "admin", "Password": "4LWS-067", "TenantAlias": "automation",
                     "UserName": "admin"}
            login_user_response = requests.post('https://amsin.hirepro.in/py/common/user/login_user/', headers=login_user_header, data=json.dumps(login_user_data), verify=True)
            self.login_user_TokenVal = login_user_response.json()

            # ----------------------------------------------------------------------------------------------------------
            #  Evaluate online assessment for candidate
            # ----------------------------------------------------------------------------------------------------------
            eval_online_assessment_header = {"content-type": "application/json", "X-AUTH-TOKEN": self.login_user_TokenVal.get("Token"),
                                             "APP-NAME": "crpoassessment"}
            eval_online_assessment_data = {"testId": TestId, "candidateIds": [candidateId]}
            eval_online_assessment_request = requests.post("https://amsin.hirepro.in/py/assessment/eval/api/v1/eval-online-assessment/",
            ...
            # ----------------------------------------------------------------------------------------------------------
            header3 = {"content-type": "application/json", "X-AUTH-TOKEN": self.login_user_TokenVal.get("Token")}
            data6 = {"TestId": TestId, "CandidateId": candidateId, "TenantId": "ETg6fWphpuw="}  # ObjVQ7rmWZg=
            ...
            testdata = json.loads(request6.content)
            print("Test Data", testdata)
            print("Test Data Type", type(testdata))
            ...
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 12857):
            ...
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46869):
            ...
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46870):
                    ...
                    if (round(Expected_Sec_2_Total, 3) == round(Actual_Section2_Score, 3)):
                        ...
                        print("Group -- Candidate_Id - ", candidateId, " Section_2_Id - ", Section_2_Id, "Expected Score - ", Expected_Sec_2_Total, "Actual Score - ", Actual_Section2_Score)
                    break
                k += 1
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46871):
                    Actual_Section3_Score = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['Score']
                    if (round(Expected_Sec_3_Total, 3) == round(Actual_Section3_Score, 3)):
                        ...
                        Section_3_Id = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId']
            ...
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 12858):
            ...
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46872):
                    ...
                    if (round(Expected_Sec_4_Total, 3) == round(Actual_Section4_Score, 3)):
                        ...
                        Section_4_Id = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k][
                            'GroupId']
                        print("Section -- Candidate_Id - ", candidateId, " Section_4_Id - ", Section_4_Id, " Expected Score - ", Expected_Sec_4_Total, " Actual Score - ", Actual_Section4_Score)
                    break
                k += 1
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46873):
                    ...
                    if (round(Expected_Sec_5_Total, 3) == round(Actual_Section5_Score, 3)):
                        ...
                        Section_5_Id = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k][
                            'GroupId']
                        print("Section -- Candidate_Id - ", candidateId, " Section_5_Id - ", Section_5_Id, " Expected Score - ", Expected_Sec_5_Total, " Actual Score - ", Actual_Section5_Score)
                    break
                k += 1
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 12859):
            ...
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46874):
                    ...
                    if (round(Expected_Sec_6_Total, 3) == round(Actual_Section6_Score, 3)):
                        ...
                        Section_6_Id = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k][
                            'GroupId']
                        print("Section -- Candidate_Id - ", candidateId, " Section_6_Id - ", Section_6_Id, " Expected Score - ", Expected_Sec_6_Total, " Actual Score - ", Actual_Section6_Score)
                    break
                k += 1
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46875):
                    ...
                    if (round(Expected_Sec_7_Total, 3) == round(Actual_Section7_Score, 3)):
                        ...
                        Section_7_Id = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k][
                            'GroupId']
                        print("Section -- Candidate_Id - ", candidateId, " Section_7_Id - ", Section_7_Id, " Expected Score - ", Expected_Sec_7_Total, " Actual Score - ", Actual_Section7_Score)
                    break
                k += 1
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 12860):
            ...
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46876):
                    Actual_Section8_Score = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k][
                        'Score']
                    # print(type(Expected_Sec_8_Total)
                    # print(type(Actual_Section8_Score)
                    if (round(Expected_Sec_8_Total, 3) == round(Actual_Section8_Score, 3)):
                    # if (not(Expected_Sec_8_Total < Actual_Section8_Score) and not(Expected_Sec_8_Total > Actual_Section8_Score)):
                        ...
                        Section_8_Id = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k][
                            'GroupId']
                        print("Section -- Candidate_Id - ", candidateId, " Section_8_Id - ", Section_8_Id, " Expected Score - ", Expected_Sec_8_Total, " Actual Score - ", Actual_Section8_Score)
                    break
                k += 1
            k = 0
            while (k <= 13):
                if (json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k]['GroupId'] == 46877):
                    ...
                    if (round(Expected_Sec_9_Total, 3) == round(Actual_Section9_Score, 3)):
                        ...
                        Section_9_Id = json.loads(request6.content)['CandidateScore']['TotalCandidateScore'][k][
                            'GroupId']
                        print("Section -- Candidate_Id - ", candidateId, " Section_9_Id - ", Section_9_Id, " Expected Score - ", Expected_Sec_9_Total, " Actual Score - ", Actual_Section9_Score)
                    break
                k += 1
