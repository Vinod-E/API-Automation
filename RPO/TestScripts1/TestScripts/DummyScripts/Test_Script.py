...
class Excel_Data:
    def __init__(self):
        ...
        self.boundary_range = [1236387,1223360,1228519,1223357,1222598,1223194,1223195,1222597,1222711,1222545,1218539,
                               1217854,1216685,1216459,1120576,1120653,1120578,1120156,1120071,1120074,1120074,1120581,
                               1120635,1236387,1223983,1219694,1218231,1217854,1120574,1120131,1120102,1117645]
    ...
    def Query_Generation(self):
        ...
        where_str = "ap.tenant_id=1782 and stag.base_name='Offer' and ap.candidate_id in ( %s )"% values
