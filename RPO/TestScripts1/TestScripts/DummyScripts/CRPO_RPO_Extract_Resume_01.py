...
class extractResume(unittest.TestCase):
    def test_extractResume(self):
        ...
        wb = xlrd.open_workbook("/home/sanjeev/TestScripts/TestScripts/Input_Data/ExtractResumeNew001.xls")
        ...
        while i < sh1.nrows:
            ...
            __attach_Resume = self.driver.find_element_by_xpath(
                "/html/body/div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[1]/div[1]/div/div[1]/upload-file/div/div/input")
            ...
            __resume_File_Name = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[1]/div[1]/div/div[1]").text
            time.sleep(7)
            print __resume_File_Name
            __extract_Resume = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[1]/div[1]/div/div[1]/button")
            ...
            __candidate_Name = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[3]/transcluded-input/div/div/form/div[1]/div/input").get_attribute(
                "value")
            time.sleep(1)
            ...
            __phone = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[3]/transcluded-input/div/div/form/div[7]/div/input").get_attribute(
                "value")
            if not __phone:
            ...
            __location = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[3]/transcluded-input/div/div/form/div[9]/div/ta-dropdown/div/div/input").get_attribute(
                "value")
            if not __location:
            ...
            __dob = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[3]/transcluded-input/div/div/form/div[4]/div/input").get_attribute(
                "value")
            if not __dob:
            ...
            __gender = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[3]/transcluded-input/div/div/form/div[5]/div/ta-dropdown/div/div/input").get_attribute(
                "value")
            if not __gender:
            ...
            __college = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[8]/transcluded-input/div/div/div[2]/table/tbody/tr/td[1]").text
            if not __college:
                ...
                if __college == "Others":
                    __collegeOthers = self.driver.find_element_by_xpath(
                        "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[8]/transcluded-input/div/div/div[2]/table/tbody/tr/td[1]").get_attribute(
                        "value")
            ...
            __degree = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[8]/transcluded-input/div/div/div[2]/table/tbody/tr/td[2]").text
            if not __degree:
            ...
            __branch = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[8]/transcluded-input/div/div/div[2]/table/tbody/tr/td[3]").text
            if not __branch:
            ...
            __yop = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[8]/transcluded-input/div/div/div[2]/table/tbody/tr/td[4]").text
            if not __yop:
            ...
            __percentageorcgpa = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[8]/transcluded-input/div/div/div[2]/table/tbody/tr/td[5]").text
            ...
            __companyName = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[9]/transcluded-input/div/div/div[2]/table/tbody/tr[1]/td[1]").text
            ...
            __desigNation = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[9]/transcluded-input/div/div/div[2]/table/tbody/tr[1]/td[2]").text
            ...
            __expFrom = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[9]/transcluded-input/div/div/div[2]/table/tbody/tr[1]/td[3]").text
            if not __expFrom:
            ...
            __expTo = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[9]/transcluded-input/div/div/div[2]/table/tbody/tr[1]/td[4]").text
            if not __expTo:
            ...
            __salary = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[9]/transcluded-input/div/div/div[2]/table/tbody/tr[1]/td[5]").text
            if not __salary:
            ...
            __isLatest = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[9]/transcluded-input/div/div/div[2]/table/tbody/tr[1]/td[7]").text
            if not __isLatest:
            ...
            __skillsOfCandidate = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[2]/transcluded-input/div/div/div[1]/div/div/span/span/span[1]").text
            ...
            sourcetype = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[5]/transcluded-input/div/div/div[1]/div/ta-dropdown/div/div/input")
