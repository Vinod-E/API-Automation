...
class Excel_Data:
    def __init__(self):
        ...
        wb = xlrd.open_workbook('/home/sanjeev/TestScripts/TestScripts/JobSearch.xls')
    ...
    def all(self):
        ...
        for i in range(0, tot_len):
            ...
            self.ws.write(self.rownum, 0, str(self.xl_request))
            if self.total_api_count == self.Query_Result1:
                ...
                self.ws.write(self.rownum, 4, mismatched_id, self.__style2)
            self.wb_result.save(
                '/home/sanjeev/TestScripts/TestScripts/Combination_Job_Search_Results/'
    ...
    def Query_Generation(self):
        ...
        where_str = "j.is_deleted=0 and j.is_archived=0 and j.tenant_id=1782"
        ...
        if self.xl_request.get("SkillIds"):
            where_str += " and jr.skill_id ={} ".format(self.xl_request.get("SkillIds")[0])
