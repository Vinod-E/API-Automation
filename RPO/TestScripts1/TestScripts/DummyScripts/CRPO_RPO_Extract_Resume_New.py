...
class extractResume(unittest.TestCase):
    ...
    def test_extractResume(self):
        ...
        wb = xlrd.open_workbook("/home/sanjeev/TestScripts/TestScripts/Input_Data/ExtractResumeSheetListOfEduAndExp1.xls")
        ...
        while cnt < sh1.nrows:
            ...
            __resume_File_Name = self.driver.find_element_by_xpath(
                "//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[1]/div[1]/div/div[2]/div[1]").text
            #self.driver.implicitly_wait(40)
            ...
            if not __candidate_Name:
                ...
                ws.write(rownum, 5, 'Name Not Extracted', __style1)
            else:
            ...
            __gender = self.driver.find_element_by_xpath('//*[@ng-item="vm.data.personalDetails.gender"]').get_attribute("value")
            if not __gender:
            ...
            __location = self.driver.find_element_by_xpath('//*[@ng-item="vm.data.personalDetails.currentLocationId"]').get_attribute("value")
            if not __location:
            ...
            __phone = self.driver.find_element_by_xpath('//*[@ng-model="vm.data.personalDetails.alternatePhone"]').get_attribute("value")
            if not __phone:
            ...
            time.sleep(1)
            __totalExpInYears = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[7]/transcluded-input/div/div/form/div[3]/div/input").get_attribute("value")
            ...
            __totalExpInMonths = self.driver.find_element_by_xpath("//div[3]/div/create-update-candidate/section/div[1]/div/div[3]/div[7]/transcluded-input/div/div/form/div[4]/div/input").get_attribute("value")
            ...
            if not self.__secondarySkills:
                ...
                if self.compare_lists(self.__secondarySkills, totalSkills.split(',')):
                    ...
                    ws.write(rownum, 2, self.__secondarySkills, __style3)
            time.sleep(5)
            wb_result.save('/home/sanjeev/TestScripts/TestScripts/DineshResume/TestResSheet(' + __current_DateTime + ').xls')
            #self.driver.quit()
            cnt += 1
